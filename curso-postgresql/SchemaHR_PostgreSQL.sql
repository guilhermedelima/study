...
IS 'Regions table that contains region integers and names. Contains 4 rows; references with the Countries table.';
...
Contains building integer and street name';
...
IS 'Phone integer of the employee; includes country code and area code';
